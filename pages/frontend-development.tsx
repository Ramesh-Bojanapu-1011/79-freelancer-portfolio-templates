          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-2xl bg-slate-50 dark:bg-slate-800 p-8 shadow-xl ring-1 ring-black/5 dark:ring-white/5 transition-shadow duration-300 hover:shadow-2xl">
              ...
              <ul className="mt-6 space-y-3 text-slate-700 dark:text-slate-300">
                <li className="flex items-start gap-2">• React/Next.js pages and routes</li>
                <li className="flex items-start gap-2">• Reusable UI components and hooks</li>
                <li className="flex items-start gap-2">• Responsive page templates and layouts</li>
                <li className="flex items-start gap-2">• Performance and accessibility improvements</li>
                <li className="flex items-start gap-2">• Deployment scripts and CI configuration</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl bg-slate-50 dark:bg-slate-800 p-8 shadow-xl ring-1 ring-black/5 dark:ring-white/5 transition-shadow duration-300 hover:shadow-2xl">
              ...
              <div className="mt-4 text-sm font-medium text-slate-500 dark:text-slate-400 border-t pt-4 border-slate-200 dark:border-slate-700">
                Includes performance audit, accessibility checks and CI
                setup.
              </div>
            </div>
